                ...
                e.exports = {
                    enable: function (t) {
                        ...
                        n.setAttribute("id", "svg-pan-zoom-controls"),
                            n.setAttribute("transform", "translate(" + (t.width - 70) + " " + (t.height - 76) + ") scale(0.75)"),
                ...
                (n.prototype.init = function (t, e) {
                    ...
                    (n.prototype.processCTM = function () {
                        ...
                        (this.options.fit || this.options.contain) &&
                            ((t = this.options.fit
                                ...
                                : Math.max(this.options.width / this.viewBox.width, this.options.height / this.viewBox.height)),
                            (e.a = t),
                            (e.d = t),
                    ...
                    (n.prototype.setCTM = function (t) {
                        ...
                        if (e || o) {
                            if (
                                (e &&
                                    (!1 === this.options.beforeZoom(this.getRelativeZoom(), this.computeRelativeZoom(t.a))
                                ...
                                !1 === n
                                    ...
                                    : r.isObject(n) &&
                                      (!1 === n.x ? ((t.e = this.getPan().x), (i = !0)) : r.isNumber(n.x) && (t.e = n.x),
                                      !1 === n.y ? ((t.f = this.getPan().y), (s = !0)) : r.isNumber(n.y) && (t.f = n.y)),
            ...
            function (t, e, o) {
                ...
                (i.prototype.init = function (t, e) {
                    ...
                    (i.prototype.zoomAtPoint = function (t, e, o) {
                        ...
                        o
                            ? ((t = Math.max(this.options.minZoom * n.zoom, Math.min(this.options.maxZoom * n.zoom, t))),
                              (t /= this.getZoom()))
                        ...
                        this.options.preventMouseEventsDefault && (t.preventDefault ? t.preventDefault() : (t.returnValue = !1)),
                            ...
                            this.options.dblClickZoomEnabled && r.isDblClick(t, e)
                                ...
                                : ((this.state = "pan"),
                                  ...
                                  (this.stateOrigin = a.getEventPoint(t, this.svg).matrixTransform(this.firstEventCTM.inverse())));
                    }),
                    ...
                    (i.prototype.resize = function () {
                        ...
                        (e.options.width = this.width),
                            ...
                            e.processCTM(),
                            this.options.controlIconsEnabled &&
                                (this.getPublicInstance().disableControlIcons(), this.getPublicInstance().enableControlIcons());
                    }),
                                ...
                                (this.publicInstance = this.pi =
                                    {
                                        ...
                                        enableControlIcons: function () {
                                            return (
                                                o.options.controlIconsEnabled || ((o.options.controlIconsEnabled = !0), s.enable(o)), o.pi
                                            );
                                        },
                                        disableControlIcons: function () {
                                            return (
                                                o.options.controlIconsEnabled && ((o.options.controlIconsEnabled = !1), s.disable(o)), o.pi
                                            );
                                        },
                        ...
                        "wheel" === a
                            ...
                            : (function (t, o) {
                                  function e(t) {
                                      ...
                                      return (
                                          "mousewheel" == a
                                              ? ((e.deltaY = -0.025 * t.wheelDelta), t.wheelDeltaX && (e.deltaX = -0.025 * t.wheelDeltaX))
                                              : (e.deltaY = t.detail),
                                          o(e)
                                      );
                                  }
