...
(function (e, t) {
    ...
    if (s && ie) {
        var pe = function defineWellKnownSymbol(e) {
            ...
            Object.defineProperty(J, e, { configurable: false, enumerable: false, writable: false, value: t });
            return t;
        };
    ...
    if (s) {
        var Or = { input: "$_", lastMatch: "$&", lastParen: "$+", leftContext: "$`", rightContext: "$'" };
        l(n(Or), function (e) {
    ...
    var _r = Math.round;
    var Rr = Math.round(0.5 - Number.EPSILON / 4) === 0 && Math.round(-0.5 + Number.EPSILON / 3.99) === 1;
    var kr = wr + 1;
    var Lr = 2 * wr - 1;
        ...
        var on = {
            Map: (function () {
                ...
                var u = function Map() {
                    ...
                    var e = _e(this, Map, a, { _es6map: true, _head: null, _map: H ? new H() : null, _size: 0, _storage: tn() });
    ...
    if (s) {
        ...
        var Nn = function set(e, r, n, o) {
            ...
            if ("value" in i) {
                ...
                return ue.defineProperty(o, r, { value: n, writable: true, enumerable: true, configurable: true });
            }
            if (i.set) {
                t(i.set, o, n);
                return true;
    ...
    if (S.Reflect.defineProperty) {
        if (
            !a(function () {
                ...
                var t =
                    typeof Object.preventExtensions !== "function" || !S.Reflect.defineProperty(Object.preventExtensions({}), "test", {});
                return e && t;
            })
        ) {
