...
!(function (t, e) {
                                ...
                                if (n === _t8.index) {
                                    ...
                                    if ("node" === _t8.type) {
                                        ...
                                        (_this2$_parts = _this2._parts).push.apply(
                                            _this2$_parts,
                                            _toConsumableArray(
                                                _this2.processor.handleAttributeExpressions(r, _t8.name, _t8.strings, _this2.options)
                                            )
                                        );
                                    s++;
        ...
        _createClass(x, [
            {
                key: "getHTML",
                value: function getHTML() {
                    return "<svg>".concat(_get(_getPrototypeOf(x.prototype), "getHTML", this).call(this), "</svg>");
                },
            },
            {
                key: "getTemplateElement",
        ...
        _createClass(N, [
            {
                ...
                value: function setValue(t) {
                    t === r || (_(t) && t === this.value) || ((this.value = t), s(t) || (this.committer.dirty = !0));
                },
            },
            {
                key: "commit",
                ...
                value: function _commitIterable(t) {
                    ...
                    try {
                        for (
                            ...
                            void 0 === (s = e[i]) &&
                                ((s = new V(this.options)), e.push(s), 0 === i ? s.appendIntoPart(this) : s.insertAfterPart(e[i - 1])),
                                s.setValue(_n3),
                                s.commit(),
                                i++;
                        }
    ...
    var w = (function (_y) {
        ...
        _createClass(w, [
            ...
            },
            {
                key: "_getValue",
                value: function _getValue() {
                    return this.single ? this.parts[0].value : _get(_getPrototypeOf(w.prototype), "_getValue", this).call(this);
                },
            },
            {
                key: "commit",
            ...
            },
            {
                ...
                value: function commit() {
                    ...
                    var t = this._pendingValue,
                        ...
                        n = null != t && (null == e || i);
                    i && this.element.removeEventListener(this.eventName, this._boundHandleEvent, this._options),
                        n && ((this._options = P(t)), this.element.addEventListener(this.eventName, this._boundHandleEvent, this._options)),
                        (this.value = t),
                        (this._pendingValue = r);
                },
            },
    ...
    function M(t) {
        ...
        return (
            void 0 === (s = e.keyString.get(i)) && ((s = new u(t, t.getTemplateElement())), e.keyString.set(i, s)),
    ...
    (t.html = function (t) {
        ...
        (t.render = function (t, e, s) {
            var i = k.get(e);
            void 0 === i && (o(e, e.firstChild), k.set(e, (i = new V(Object.assign({ templateFactory: M }, s)))), i.appendInto(e)),
                i.setValue(t),
                i.commit();
        }),
        (t.templateCaches = L),
