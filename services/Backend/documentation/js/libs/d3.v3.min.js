...
!(function () {
    ...
    function U(n) {
        function t() {
            var t = this.ownerDocument,
                e = this.namespaceURI;
            return e === bo && t.documentElement.namespaceURI === bo ? t.createElement(n) : t.createElementNS(e, n);
        }
        function e() {
    ...
    function sn(n, t, e) {
        return isNaN(n) && (n = 0), isNaN(t) && (t = 0), new hn(e, Math.cos((n *= Do)) * t, Math.sin(n) * t);
    }
    function hn(n, t, e) {
    ...
    function bn(n, t, e) {
        ...
        return (u = Wo.get(n))
            ...
            : (null == n ||
                  ...
                  (4 === n.length
                      ? ((o = (3840 & u) >> 4), (o |= o >> 4), (a = 240 & u), (a |= a >> 4), (l = 15 & u), (l |= l << 4))
    ...
    function Sn(n, t, e) {
        ...
        return hn(116 * i - 16, 500 * (r - i), 200 * (i - vn((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / Xo)));
    }
    function kn(n) {
    ...
    function qn(n, t, e) {
        ...
        return Go ? (Go.n = i) : (Jo = i), (Go = i), Ko || ((Qo = clearTimeout(Qo)), (Ko = 1), na(Tn)), i;
    }
    function Tn() {
        var n = Rn(),
            t = Dn() - n;
        t > 24 ? (isFinite(t) && (clearTimeout(Qo), (Qo = setTimeout(Tn, t))), (Ko = 0)) : ((Ko = 1), na(Tn));
    }
    function Rn() {
    ...
    function Dn() {
        for (var n, t = Jo, e = 1 / 0; t; ) t.c ? (t.t < e && (e = t.t), (t = (n = t).n)) : (t = n ? (n.n = t.n) : (Jo = t.n));
        return (Go = n), e;
    }
    function Pn(n, t) {
                            ...
                            : "W" in r || "U" in r
                              ? ("w" in r || (r.w = "W" in r ? 1 : 0),
                                ...
                                u.setFullYear(
                                    r.y,
                                    0,
                                    "W" in r ? ((r.w + 6) % 7) + 7 * r.W - ((u.getDay() + 5) % 7) : r.w + 7 * r.U - ((u.getDay() + 6) % 7)
                                ))
        ...
        function e(n, t, e, r) {
            for (var i, u, o, a = 0, l = t.length, c = e.length; a < l; ) {
                ...
                if (37 === (i = t.charCodeAt(a++))) {
                    if (((o = t.charAt(a++)), !(u = C[o in aa ? t.charAt(a++) : o]) || (r = u(n, e, r)) < 0)) return -1;
    ...
    function dt() {
        ...
        (va.point = function (o, a) {
            (va.point = n), (r = (t = o) * Do), (i = Math.cos((a = ((e = a) * Do) / 2 + Lo / 4))), (u = Math.sin(a));
        }),
            (va.lineEnd = function () {
                n(t, e);
            });
    ...
    function Nt() {
        function n(n, i) {
            ...
            (ma += c), (ba += c * (t + (t = o))), (wa += c * (e + (e = a))), (Sa += c * (r + (r = l))), kt(t, e, r);
        }
        var t, e, r;
                ...
                if ((d.pop(), g.push(d), (d = null), r))
                    if (1 & t) {
                        ...
                        if ((r = (n = e[0]).length - 1) > 0) {
                            for (_ || (u.polygonStart(), (_ = !0)), u.lineStart(); ++o < r; ) u.point((i = n[o])[0], i[1]);
                            u.lineEnd();
                        }
                ...
                m = {
                    ...
                    polygonEnd: function () {
                        ...
                        p.length
                            ...
                            : n && (_ || (u.polygonStart(), (_ = !0)), u.lineStart(), e(null, null, 1, u), u.lineEnd()),
                            _ && (u.polygonEnd(), (_ = !1)),
                            (p = g = null);
                    },
                    sphere: function () {
    ...
    function jt(n, t) {
        return ((n = n.x)[0] < 0 ? n[1] - Ro - Co : Ro - n[1]) - ((t = t.x)[0] < 0 ? t[1] - Ro - Co : Ro - t[1]);
    }
    function Ut(n) {
        var t,
            e = NaN,
    ...
    function Ft(n, t, e, r) {
        var i,
            ...
            o = Math.sin(n - e);
        return so(o) > Co
            ? Math.atan((Math.sin(t) * (u = Math.cos(r)) * Math.sin(e) - Math.sin(r) * (i = Math.cos(t)) * Math.sin(n)) / (i * u * o))
            : (t + r) / 2;
    }
    function Ht(n, t, e, r) {
        var i;
    ...
    function Ot(n, t) {
        ...
        for (var a = 0, l = t.length; a < l; ++a) {
            var c = t[a],
                f = c.length;
            if (f)
                for (var s = c[0], h = s[0], p = s[1] / 2 + Lo / 4, g = Math.sin(p), d = Math.cos(p), v = 1; ; ) {
                    v === f && (v = 0);
                    var y = (n = c[v])[0],
                        m = n[1] / 2 + Lo / 4,
                        x = Math.sin(m),
        ...
        function e(n) {
            ...
            return {
                ...
                point: function (s, h) {
                    ...
                    if (
                        (!e && (c = l = d) && n.lineStart(),
                        d !== l && ((p = r(e, g)), (wt(e, p) || wt(g, p)) && ((g[0] += Co), (g[1] += Co), (d = t(g[0], g[1])))),
                        d !== l)
                    )
                        (f = 0),
                            d ? (n.lineStart(), (p = r(g, e)), n.point(p[0], p[1])) : ((p = r(e, g)), n.point(p[0], p[1]), n.lineEnd()),
                            (e = p);
                    else if (a && e && o ^ d) {
                        var y;
                        v & u ||
    ...
    function Zt(n, t, e, r) {
        ...
        return function (a) {
            ...
            function g(n, t) {
                ...
                if ((v && y.push([n, t]), S)) (m = n), (x = t), (M = e), (S = !1), e && (a.lineStart(), a.point(n, t));
    ...
    function ee(n) {
        ...
        function r(t) {
            ...
            function u(e, r) {
                var u = vt([e, r]),
                    o = n(e, r);
                i(x, M, m, _, b, w, (x = o[0]), (M = o[1]), (m = e), (_ = u[0]), (b = u[1]), (w = u[2]), a, t), t.point(x, M);
            }
            function o() {
                (S.point = e), t.lineEnd();
            }
        ...
        function i(t, e, r, a, l, c, f, s, h, p, g, d, v, y) {
            ...
            if (M > 4 * u && v--) {
                ...
                ((q * q) / M > u || so((m * z + x * L) / M - 0.5) > 0.3 || a * p + l * g + c * d < o) &&
                    (i(t, e, r, a, l, c, A, C, N, (_ /= S), (b /= S), w, v, y), y.point(A, C), i(A, C, N, _, b, w, f, s, h, p, g, d, v, y));
            }
        }
        var u = 0.5,
            o = Math.cos(30 * Do),
    ...
    function ae(n) {
        ...
        return (
            ...
            (t.clipExtent = function (n) {
                return arguments.length ? ((S = n), (b = n ? Zt(n[0][0], n[0][1], n[1][0], n[1][1]) : m), i()) : S;
            }),
            (t.scale = function (n) {
            ...
            (t.center = function (n) {
                return arguments.length ? ((d = (n[0] % 360) * Do), (v = (n[1] % 360) * Do), r()) : [d * Po, v * Po];
            }),
            (t.rotate = function (n) {
                return arguments.length
                    ? ((y = (n[0] % 360) * Do), (x = (n[1] % 360) * Do), (M = n.length > 2 ? (n[2] % 360) * Do : 0), r())
                    : [y * Po, x * Po, M * Po];
            }),
    ...
    function de(n, t) {
        ...
        return function (i, u, o, a) {
            var l = o * t;
            null != i ? ((i = ve(e, i)), (u = ve(e, u)), (o > 0 ? i < u : i > u) && (i += o * qo)) : ((i = n + o * qo), (u = n - 0.5 * l));
            for (var c, f = i; o > 0 ? f > u : f < u; f -= l) a.point((c = bt([e, -r * Math.cos(f), -r * Math.sin(f)]))[0], c[1]);
        };
    }
    function ve(n, t) {
        var e = vt(t);
    ...
    function be() {
        function n(n, i) {
            var u = Math.sin((i *= Do)),
                ...
                a = so((n *= Do) - t),
                l = Math.cos(a);
            (Ha += Math.atan2(Math.sqrt((a = o * Math.sin(a)) * a + (a = r * u - e * o * l) * a), e * u + r * o * l)),
                (t = n),
                (e = u),
                (r = o);
        }
    ...
    function Fe(n) {
        var t = n.circle,
            ...
            a = [n];
        Ue(n);
        for (var l = u; l.circle && so(e - l.circle.x) < Co && so(r - l.circle.cy) < Co; ) (u = l.P), a.unshift(l), Ue(l), (l = u);
        a.unshift(l), Be(l);
        for (var c = o; c.circle && so(e - c.circle.x) < Co && so(r - c.circle.cy) < Co; ) (o = c.N), a.push(c), Ue(c), (c = o);
        a.push(c), Be(c);
        var f,
            s = a.length;
    ...
    function He(n) {
        ...
        if ((Ja.insert(t, l), t || e)) {
            if (t === e) return Be(t), (e = je(t.site)), Ja.insert(l, e), (l.edge = e.edge = Ke(t.site, l.site)), $e(t), void $e(e);
            if (e) {
                Be(t), Be(e);
                var c = t.site,
                    f = c.x,
                ...
                nr(e.edge, c, g, M), (l.edge = Ke(c, n, null, M)), (e.edge = Ke(n, g, null, M)), $e(t), $e(e);
    ...
    function Ze(n) {
        for (var t, e, r, i, u, o, a, l, c, f, s = n[0][0], h = n[1][0], p = n[0][1], g = n[1][1], d = Wa, v = d.length; v--; )
            if ((u = d[v]) && u.prepare())
    ...
    function We(n) {
        for (var t, e = Ba, r = It(n[0][0], n[0][1], n[1][0], n[1][1]), i = e.length; i--; )
            (!Je((t = e[i]), n) || !r(t) || (so(t.a.x - t.b.x) < Co && so(t.a.y - t.b.y) < Co)) && ((t.a = t.b = null), e.splice(i, 1));
    }
    function Je(n, t) {
        var e = n.b;
        if (e) return !0;
    ...
    function ar(n, t) {
        ...
        for (Ba = [], Wa = new Array(n.length), Ja = new er(), Ka = new er(); ; )
            if (((i = Ga), u && (!i || u.y < i.y || (u.y === i.y && u.x < i.x))))
                (u.x === e && u.y === r) || ((Wa[u.i] = new Ie(u)), He(u), (e = u.x), (r = u.y)), (u = n.pop());
            else {
                if (!i) break;
                Fe(i.arc);
            }
        ...
        return (
            (function n(c, f, s, h, p) {
                if (!(f > u || s > o || h < r || p < i)) {
                    ...
                    for (var x = c.nodes, M = 0.5 * (f + h), _ = 0.5 * (s + p), b = ((e >= _) << 1) | (t >= M), w = b + 4; b < w; ++b)
                        if ((c = x[3 & b]))
                            switch (3 & b) {
                                case 0:
                                    n(c, f, s, M, _);
    ...
    function gr(n, t) {
        ...
        var e = n.r,
            ...
            a = t.b - i;
        return function (n) {
            return "#" + _n(Math.round(e + u * n)) + _n(Math.round(r + o * n)) + _n(Math.round(i + a * n));
        };
    }
    function dr(n, t) {
        var e,
    ...
    function yr(n, t) {
        ...
        for (n += "", t += ""; (e = el.exec(n)) && (r = rl.exec(t)); )
            (i = r.index) > u && ((i = t.slice(u, i)), a[o] ? (a[o] += i) : (a[++o] = i)),
                (e = e[0]) === (r = r[0]) ? (a[o] ? (a[o] += r) : (a[++o] = r)) : ((a[++o] = null), l.push({ i: o, x: vr(e, r) })),
                (u = rl.lastIndex);
        return (
    ...
    function Tr(n, t) {
        ...
        return (
            ...
            isNaN(u) ? ((u = 0), (e = isNaN(e) ? t.h : e)) : u > 180 ? (u -= 360) : u < -180 && (u += 360),
            function (n) {
    ...
    function Ir(n, t, e, r) {
        n !== t
            ? (n - t > 180 ? (t += 360) : t - n > 180 && (n += 360), r.push({ i: e.push(Or(e) + "rotate(", null, ")") - 2, x: vr(n, t) }))
            : t && e.push(Or(e) + "rotate(" + t + ")");
    }
    function Zr(n, t, e, r) {
        n !== t ? r.push({ i: e.push(Or(e) + "skewX(", null, ")") - 2, x: vr(n, t) }) : t && e.push(Or(e) + "skewX(" + t + ")");
    }
    function Vr(n, t, e, r) {
        if (n[0] !== t[0] || n[1] !== t[1]) {
    ...
    function Wr(n) {
        for (var t = n.source, e = n.target, r = Gr(t, e), i = [t]; t !== r; ) (t = t.parent), i.push(t);
    ...
    function Gr(n, t) {
        if (n === t) return n;
        for (var e = Jr(n), r = Jr(t), i = e.pop(), u = r.pop(), o = null; i === u; ) (o = i), (i = e.pop()), (u = r.pop());
        return o;
    }
    function Kr(n) {
        n.fixed |= 2;
    ...
    function ei(n, t, e) {
        ...
        if (((n.charge = 0), !n.leaf))
            for (var u, o = n.nodes, a = o.length, l = -1; ++l < a; )
                null != (u = o[l]) && (ei(u, t, e), (n.charge += u.charge), (r += u.charge * u.cx), (i += u.charge * u.cy));
        if (n.point) {
    ...
    function ki(n) {
        ...
        if ((e = n.children) && (c = e.length)) {
            var e,
                ...
                h = 1 / 0,
                p = -1 / 0;
            if ((e.forEach(Ni), (r = e[0]), (r.x = -r.r), (r.y = 0), t(r), c > 1 && ((i = e[1]), (i.x = i.r), (i.y = 0), t(i), c > 2)))
                for (Ci(r, i, (u = e[2])), t(u), bi(r, u), r._pack_prev = u, bi(u, i), i = r._pack_next, o = 3; o < c; o++) {
                    Ci(r, i, (u = e[o]));
                    var g = 0,
                        d = 1,
                        v = 1;
                    ...
                    if (1 == g) for (l = r._pack_prev; l !== a._pack_prev && !Si(l, u); l = l._pack_prev, v++);
                    g ? (d < v || (d == v && i.r < r.r) ? wi(r, (i = a)) : wi((r = l), i), o--) : (bi(r, u), (i = u), t(u));
                }
            var y = (f + s) / 2,
                m = (h + p) / 2,
                x = 0;
            for (o = 0; o < c; o++) ((u = e[o]).x -= y), (u.y -= m), (x = Math.max(x, u.r + Math.sqrt(u.x * u.x + u.y * u.y)));
            (n.r = x), e.forEach(Ei);
        }
    }
    function Ni(n) {
    ...
    function Ai(n, t, e, r) {
        var i = n.children;
        if (((n.x = t += r * n.x), (n.y = e += r * n.y), (n.r *= r), i)) for (var u = -1, o = i.length; ++u < o; ) Ai(i[u], t, e, r);
    }
    function Ci(n, t, e) {
        var r = n.r + e.r,
            i = t.x - n.x,
    ...
    function Ji(n, t) {
        var e = Wi(t[2]);
        return n in dl ? Math.abs(e - Wi(Math.max(so(t[0]), so(t[1])))) + +("e" !== n) : e - 2 * ("%" === n);
    }
    function Gi(n, t, e, r) {
        function i(n) {
    ...
    function nu(n, t) {
        ...
        return (
            ...
            (e.rangeBands = function (i, a, l) {
                ...
                return (u = r(f + s * l, s)), c && u.reverse(), (o = s * (1 - a)), (t = { t: "rangeBands", a: arguments }), e;
            }),
    ...
    function pu(n) {
        ...
        return (
            ...
            (t.interpolate = function (n) {
                return arguments.length ? ((o = "function" == typeof n ? (u = n) : (u = wl.get(n) || gu).key), t) : o;
            }),
    ...
    function Mu(n, t) {
        return n.length < 3 ? du(n) : n[0] + bu((n.push(n[0]), n), wu([n[n.length - 2]].concat(n, [n[1]]), t));
    }
    function _u(n, t) {
    ...
    function bu(n, t) {
        ...
        var e = n.length != t.length,
            ...
            l = 1;
        if (
            (e && ((r += "Q" + (u[0] - (2 * o[0]) / 3) + "," + (u[1] - (2 * o[1]) / 3) + "," + u[0] + "," + u[1]), (i = n[1]), (l = 2)),
            t.length > 1)
        ) {
            (a = t[1]),
                (u = n[l]),
    ...
    function Su(n) {
        ...
        for (n.push(n[e - 1]); ++t <= e; ) (r = n[t]), o.shift(), o.push(r[0]), a.shift(), a.push(r[1]), Cu(l, o, a);
    ...
    function ku(n) {
        ...
        for (e.push(Au(Nl, u) + "," + Au(Nl, o)), --r; ++r < i; ) (t = n[r]), u.shift(), u.push(t[0]), o.shift(), o.push(t[1]), Cu(e, u, o);
        return e.join("");
    }
    function Nu(n) {
        for (var t, e, r = -1, i = n.length, u = i + 4, o = [], a = []; ++r < 4; ) (e = n[r % i]), o.push(e[0]), a.push(e[1]);
        for (t = [Au(Nl, o), ",", Au(Nl, a)], --r; ++r < u; ) (e = n[r % i]), o.shift(), o.push(e[0]), a.shift(), a.push(e[1]), Cu(t, o, a);
        return t.join("");
    }
    function Eu(n, t) {
        var e = n.length - 1;
        if (e)
            for (var r, i, u = n[0][0], o = n[0][1], a = n[e][0] - u, l = n[e][1] - o, c = -1; ++c <= e; )
                (i = c / e), ((r = n[c])[0] = t * r[0] + (1 - t) * (u + i * a)), (r[1] = t * r[1] + (1 - t) * (o + i * l));
        return Su(n);
    }
    function Au(n, t) {
    ...
    function Cu(n, t, e) {
        n.push("C", Au(Sl, t), ",", Au(Sl, e), ",", Au(kl, t), ",", Au(kl, e), ",", Au(Nl, t), ",", Au(Nl, e));
    }
    function zu(n, t) {
    ...
    function Du(n) {
        function t(t) {
            ...
            for (
                ...
                o.call(this, (h = t[m]), m)
                    ? (v.push([(p = +M.call(this, h, m)), (g = +_.call(this, h, m))]), y.push([+b.call(this, h, m), +w.call(this, h, m)]))
                    : v.length && (l(), (v = []), (y = []));
    ...
    function $u(n, t, e, r, i) {
        ...
        function a(i) {
            ...
            if (u >= 1) return d.event && d.event.end.call(n, n.__data__, t), --g.count ? delete g[r] : delete n[e], 1;
        }
        var l,
            f,
            s,
        ...
        d ||
            ((l = i.time),
            (f = qn(u, 0, l)),
            (d = g[r] = { tween: new c(), time: l, timer: f, delay: i.delay, duration: i.duration, ease: i.ease, index: t }),
            (i = null),
            ++g.count);
    }
    function Bu(n, t, e) {
    ...
    (to.ascending = e),
        ...
        (to.variance = function (n, t) {
            var e,
                ...
                c = -1,
                f = 0;
            if (1 === arguments.length) for (; ++c < o; ) i((e = r(n[c]))) && (l += (u = e - a) * (e - (a += u / ++f)));
            else for (; ++c < o; ) i((e = r(t.call(n, n[c], c)))) && (l += (u = e - a) * (e - (a += u / ++f)));
            if (f > 1) return l / (f - 1);
        }),
    ...
    (to.ns = {
        ...
        qualify: function (n) {
            var t = n.indexOf(":"),
                e = n;
            return t >= 0 && "xmlns" !== (e = n.slice(0, t)) && (n = n.slice(t + 1)), wo.hasOwnProperty(e) ? { space: wo[e], local: n } : n;
        },
    }),
            ...
            function e(n, e) {
                ...
                if (t) {
                    var v,
                        y = new c(),
                        m = new Array(o);
                    for (r = -1; ++r < o; ) (i = n[r]) && (y.has((v = t.call(i, i.__data__, r))) ? (d[r] = i) : y.set(v, i), (m[r] = v));
                    for (r = -1; ++r < s; )
                        (i = y.get((v = t.call(e, (u = e[r]), r)))) ? !0 !== i && ((p[r] = i), (i.__data__ = u)) : (g[r] = H(u)),
                            y.set(v, !0);
                ...
                (g.update = p), (g.parentNode = p.parentNode = d.parentNode = n.parentNode), a.push(g), l.push(p), f.push(d);
            }
            var r,
                i,
                u = -1,
    ...
    (to.selection.enter = Z),
        ...
        (to.select = function (t) {
            var e;
            return "string" == typeof t ? ((e = [mo(t, io)]).parentNode = io.documentElement) : ((e = [t]).parentNode = n(t)), E([e]);
        }),
        (to.selectAll = function (n) {
            var t;
            return "string" == typeof n ? ((t = ro(xo(n, io))).parentNode = io.documentElement) : ((t = ro(n)).parentNode = null), E([t]);
        }),
            ...
            function e(n, t, e, u, o) {
                return function () {
                    ...
                    var c,
                        ...
                        m = W(s),
                        x = t(h, d);
                    i ? ((c = i.apply(f, arguments)), (c = [c.x - x[0], c.y - x[1]])) : (c = [0, 0]), p({ type: "dragstart" });
                };
            }
        ...
        (to.behavior.zoom = function () {
            ...
            function h() {
                ...
                function t() {
                    ...
                    for (var e = to.event.changedTouches, i = 0, u = e.length; i < u; ++i) v[e[i].identifier] = null;
                    var l = n(),
                        c = Date.now();
                    if (1 === l.length) {
                        if (c - x < 500) {
                ...
                function a() {
                    if (to.event.touches.length) {
                        for (var t = to.event.changedTouches, e = 0, r = t.length; e < r; ++e) delete v[t[e].identifier];
                ...
                (e.parseRows = function (n, t) {
                    function e() {
                        ...
                        if (34 === n.charCodeAt(t)) {
                            ...
                            return (
                                (f = e + 2),
                                13 === (r = n.charCodeAt(e + 1)) ? ((i = !0), 10 === n.charCodeAt(e + 2) && ++f) : 10 === r && (i = !0),
    ...
    var ta = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(jn);
    ...
    var ea = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
        ra = to.map({
            ...
            r: function (n, t) {
                return (n = to.round(n, Pn(n, t))).toFixed(Math.max(0, Math.min(20, Pn(n * (1 + 1e-15), t))));
            },
        }),
        ia = (to.time = {}),
        ua = Date;
    ...
    (to.geo.bounds = (function () {
        ...
        return function (n) {
            ...
            if (t) {
                ...
                for (var e = 1, r = [(g = x[0])]; e < t; ++e)
                    c((u = x[e])[0], g) || c(u[1], g)
                        ? (a(g[0], u[1]) > a(g[0], g[1]) && (g[1] = u[1]), a(u[0], g[1]) > a(g[0], g[1]) && (g[0] = u[0]))
                        : r.push((g = u));
        ...
        (to.geo.centroid = function (n) {
            ...
            var t = ka,
                ...
                r = Ea,
                i = t * t + e * e + r * r;
            return i < zo && ((t = ba), (e = wa), (r = Sa), ma < Co && ((t = xa), (e = Ma), (r = _a)), (i = t * t + e * e + r * r) < zo)
                ? [NaN, NaN]
    ...
    (to.geo.clipExtent = function () {
        ...
        (to.geo.albers = function () {
            return to.geo.conicEqualArea().rotate([96, 0]).center([-0.6, 38.7]).parallels([29.5, 45.5]).scale(1070);
        }),
    ...
    (to.geo.path = function () {
        function n(n) {
            return (
                n &&
                    ("function" == typeof a && u.pointRadius(+a.apply(this, arguments)), (o && o.valid) || (o = i(u)), to.geo.stream(n, o)),
                u.result()
            );
        }
        function t() {
        ...
        ($a.clip = function (n) {
            for (var t, e, r, i, u, o, a = De(n), l = -1, c = this.length - De(this), f = this[c - 1]; ++l < c; ) {
                for (t = n.slice(), n.length = 0, i = this[l], u = t[(r = t.length - a) - 1], e = -1; ++e < r; )
                    Te((o = t[e]), f, i) ? (Te(u, f, i) || n.push(Re(u, o, f, i)), n.push(o)) : Te(u, f, i) && n.push(Re(u, o, f, i)),
                        (u = o);
                a && n.push(n[0]), (f = i);
            }
            return n;
                ...
                if (
                    ...
                    u && o
                        ? ((r = e.C),
                          ...
                          (e.L = u),
                          (u.U = e),
                          e !== o ? ((i = e.U), (e.U = n.U), (n = e.R), (i.L = n), (e.R = o), (o.U = e)) : ((e.U = i), (i = e), (n = e.R)))
                        : ((r = n.C), (n = e)),
                    n && (n.U = i),
                    !r)
                )
                    if (n && n.C) n.C = !1;
                        ...
                        do {
                            if (n === this._) break;
                            if (n === i.L) {
                                if (((t = i.R).C && ((t.C = !1), (i.C = !0), ir(this, i), (t = i.R)), (t.L && t.L.C) || (t.R && t.R.C))) {
                                ...
                                ((t = i.L).C && ((t.C = !1), (i.C = !0), ur(this, i), (t = i.L)), (t.L && t.L.C) || (t.R && t.R.C))
                            ) {
            ...
            function u(n) {
                ...
                function c(n, t, e, r, i, o, a, l) {
                    var c = 0.5 * (i + a),
                        ...
                        p = (h << 1) | s;
                    (n.leaf = !1),
                        (n = n.nodes[p] || (n.nodes[p] = { leaf: !0, nodes: [], point: null, x: null, y: null })),
                        s ? (i = c) : (a = c),
                        h ? (o = f) : (l = f),
                        u(n, t, e, r, i, o, a, l);
                }
                ...
                if (null != t) (d = t), (v = e), (y = r), (m = i);
                    ...
                    for (p = 0; p < g; ++p) {
                        var _ = +x((f = n[p]), p),
                            b = +M(f, p);
                        _ < d && (d = _), b < v && (v = b), _ > y && (y = _), b > m && (m = b), s.push(_), h.push(b);
                    }
                var w = y - d,
                    S = m - v;
                w > S ? (m = v + w) : (y = d + S);
        ...
        (to.layout.force = function () {
            ...
            return (
                (l.tick = function () {
                    ...
                    if (g) for (ei((t = to.geom.quadtree(x)), i, a), r = -1; ++r < b; ) (l = x[r]).fixed || t.visit(n(l));
                    for (r = -1; ++r < b; )
                        (l = x[r]).fixed
                            ? ((l.x = l.px), (l.y = l.py))
                ...
                (l.start = function () {
                    ...
                    for (t = 0; t < i; ++t)
                        (r = x[t]),
                            ...
                            isNaN(r.px) && (r.px = r.x),
                            isNaN(r.py) && (r.py = r.y);
                    if (((u = []), "function" == typeof h)) for (t = 0; t < c; ++t) u[t] = +h.call(this, M[t], t);
                    else for (t = 0; t < c; ++t) u[t] = h;
                    if (((o = []), "function" == typeof p)) for (t = 0; t < c; ++t) o[t] = +p.call(this, M[t], t);
                    else for (t = 0; t < c; ++t) o[t] = p;
                    if (((a = []), "function" == typeof g)) for (t = 0; t < i; ++t) a[t] = +g.call(this, x[t], t);
                ...
                (l.drag = function () {
                    if (
                        (r || (r = to.behavior.drag().origin(m).on("dragstart.force", Kr).on("drag.force", t).on("dragend.force", Qr)),
                        !arguments.length)
                    )
                        return r;
            ...
            function n(o) {
                ...
                return (
                    ...
                    v.forEach(function (n) {
                        y[n] = { data: o[n], value: (a = c[n]), startAngle: f, endAngle: (f += a * d + p), padAngle: h };
                    }),
                    y
                );
            }
    ...
    to.layout.stack = function () {
        function n(a, l) {
            ...
            var h,
                ...
                y = c[0].length;
            for (g = 0; g < y; ++g)
                for (i.call(n, c[0][g], (d = v[g]), f[0][g][1]), p = 1; p < h; ++p) i.call(n, c[p][g], (d += f[p - 1][g][1]), f[p][g][1]);
            return a;
        }
        var t = m,
            e = pi,
    ...
    (to.layout.histogram = function () {
        function n(n, u) {
            ...
            if (p > 0)
                for (u = -1; ++u < h; ) (a = c[u]) >= f[0] && a <= f[1] && (((o = l[to.bisect(s, a, 1, p) - 1]).y += g), o.push(n[u]));
            return l;
        }
        var t = !0,
            e = Number,
        ...
        (to.layout.tree = function () {
            ...
            function t(n) {
                ...
                for (var i = [], u = n.children ? n.children.length : 0, o = 0; o < u; ++o) i.push(t(n.children[o]));
            ...
            function o(n, t, e) {
                for (var r = n.children[t - 1], i = r.mod, u = n.children[t], o = u.mod; null != r && null != u; ) {
                    f(r) > e.lowY && (e = e.nxt);
                    var p = i + r.prelim - (o + u.prelim);
                    null != _ ? (p += _(r.t, u.t) * N.x_size) : null != b && (p += r.x_size / 2 + u.x_size / 2 + b(r.t, u.t)),
                        p > 0
                            ? ((o += p), a(n, t, e.index, p))
                            : 1 === t && 0 === o && 0 === r.num_children && u.num_children > 1 && p < 0 && ((o += p), a(n, t, e.index, p));
                    var g = f(r),
                        d = f(u);
                    g <= d && null != (r = c(r)) && (i += r.mod), g >= d && null != (u = l(u)) && (o += u.mod);
                }
                null == r && null != u ? s(n, t, u, o) : null != r && null == u && h(n, t, r, i);
            }
            function a(n, t, e, r) {
                (n.children[t].mod += r), (n.children[t].msel += r), (n.children[t].mser += r), d(n, t, e, r);
            }
            function l(n) {
            ...
            function s(n, t, e, r) {
                ...
                (i.mod += u), (i.prelim -= u), (n.children[0].el = n.children[t].el), (n.children[0].msel = n.children[t].msel);
            }
            function h(n, t, e, r) {
                var i = n.children[t].er;
                i.tr = e;
                var u = r - e.mod - n.children[t].mser;
                (i.mod += u), (i.prelim -= u), (n.children[t].er = n.children[t - 1].er), (n.children[t].mser = n.children[t - 1].mser);
            }
            function p(n) {
                n.prelim =
                    (n.children[0].prelim +
            ...
            function d(n, t, e, r) {
                if (e != t - 1) {
                    var i = t - e;
                    (n.children[e + 1].shift += r / i), (n.children[t].shift -= r / i), (n.children[t].change -= r - r / i);
                }
            }
            function v(n) {
        ...
        (to.layout.cluster = function () {
            function n(n, u) {
                ...
                ui(l, function (n) {
                    var t = n.children;
                    t && t.length ? ((n.x = qi(t)), (n.y = Li(t))) : ((n.x = o ? (c += e(n, o)) : 0), (n.y = 0), (o = n));
                });
                var f = Ti(l),
                    s = Ri(l),
                    h = f.x - e(f, s) / 2,
            ...
            function i(n, t, e, r) {
                ...
                if (t == e.dx) {
                    for ((r || f > e.dy) && (f = e.dy); ++u < o; )
                        ((i = n[u]).x = a), (i.y = c), (i.dy = f), (a += i.dx = Math.min(e.x + e.dx - a, f ? l(i.area / f) : 0));
                    (i.z = !0), (i.dx += e.x + e.dx - a), (e.y += f), (e.dy -= f);
                } else {
                    for ((r || f > e.dx) && (f = e.dx); ++u < o; )
                        ((i = n[u]).x = a), (i.y = c), (i.dx = f), (c += i.dy = Math.min(e.y + e.dy - c, f ? l(i.area / f) : 0));
    ...
    var ml = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(Mn),
        xl = [
            2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330,
            16234194, 8355711, 13092807, 12369186, 14408589, 1556175, 10410725,
        ].map(Mn),
        Ml = [
            3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169,
            11356490, 14049643, 15177372, 8077683, 10834324, 13528509, 14589654,
        ].map(Mn),
        _l = [
            3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281,
            10394312, 12369372, 14342891, 6513507, 9868950, 12434877, 14277081,
        ].map(Mn);
        ...
        (to.svg.arc = function () {
            function n() {
                var n = Math.max(0, +e.apply(this, arguments)),
                    ...
                    h = Math.abs(s - f),
                    p = f > s ? 0 : 1;
                if ((c < n && ((g = c), (c = n), (n = g)), h >= To)) return t(c, p) + (n ? t(n, 1 - p) : "") + "Z";
                var g,
                    d,
                    v,
                    y,
                ...
                if (
                    ...
                    (m = c * Math.cos(f + E)), (x = c * Math.sin(f + E)), (M = c * Math.cos(s - E)), (_ = c * Math.sin(s - E));
                ...
                if (n) {
                    (b = n * Math.cos(s - N)), (w = n * Math.sin(s - N)), (S = n * Math.cos(f + N)), (k = n * Math.sin(f + N));
        ...
        (to.svg.chord = function () {
            function n(n, a) {
                ...
                return (
                    ...
                    (e(l, c) ? i(l.r, l.p1, l.r, l.p0) : i(l.r, l.p1, c.r, c.p0) + r(c.r, c.p1, c.a1 - c.a0) + i(c.r, c.p1, l.r, l.p0)) +
                    "Z"
                );
            }
            function t(n, t, e, r) {
    ...
    (_o.transition = function (n) {
        for (
            ...
            u.push((t = []));
            for (var c = this[a], f = -1, s = c.length; ++f < s; ) (e = c[f]) && $u(e, f, i, r, o), t.push(e);
        }
        return Iu(u, i, r);
    }),
    ...
    (Tl.call = _o.call),
        ...
        (Tl.transition = function () {
            for (var n, t, e, r, i = this.id, u = ++Rl, o = this.namespace, a = [], l = 0, c = this.length; l < c; l++) {
                a.push((n = []));
                for (var f = 0, s = (t = this[l]).length; f < s; f++)
                    (e = t[f]) &&
                        $u(e, f, o, u, { time: (r = e[o][i]).time, ease: r.ease, delay: r.delay + r.duration, duration: r.duration }),
                        n.push(e);
            }
            return Iu(a, o, u);
        }),
        ...
        function u() {
            ...
            function v() {
                ...
                M && ((n[0] += M[0]), (n[1] += M[1])),
                    C ||
                        (to.event.altKey
                            ? (x || (x = [(s[0] + s[1]) / 2, (h[0] + h[1]) / 2]), (L[0] = s[+(n[0] < x[0])]), (L[1] = h[+(n[1] < x[1])]))
                            : (x = null)),
                    E && y(n, c, 0) && (r(k), (t = !0)),
                    A && y(n, f, 1) && (i(k), (t = !0)),
            ...
            function y(n, t, e) {
                ...
                if (
                    ...
                    C ? (i = (r += f) + v) : (x && (f = Math.max(l, Math.min(c, 2 * x[e] - r))), f < r ? ((i = r), (r = f)) : (i = f)),
                    d[0] != r || d[1] != i)
                )
    ...
    var Yl = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
        Il = [
            [ia.second, 1],
            [ia.second, 5],
            [ia.second, 15],
