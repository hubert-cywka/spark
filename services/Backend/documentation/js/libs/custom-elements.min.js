(function () {
        ...
        for (var d = b; d; ) {
            if (d.nodeType === Node.ELEMENT_NODE) {
                ...
                if ("link" === f && "import" === e.getAttribute("rel")) {
                    d = e.import;
                    if (d instanceof Node && !c.has(d)) for (c.add(d), d = d.firstChild; d; d = d.nextSibling) t(d, a, c);
                    d = p(b, e);
                    continue;
                } else if ("template" === f) {
                    d = p(b, e);
    ...
    D.prototype.f = function (b) {
        ...
        for (a = 0; a < b.length; a++) for (var c = b[a].addedNodes, d = 0; d < c.length; d++) C(this.c, c[d]);
    };
    function ca() {
        var b = this;
    ...
    function da(b) {
        if (!1 !== b.g) {
            ...
            for (; 0 < a.length; ) {
                for (var f = a.shift(), e = f.localName, f = d.get(f.localName), r = 0; r < f.length; r++) A(b.c, f[r]);
                (e = b.o.get(e)) && F(e);
            }
        }
    }
    ...
    function ya(b) {
        ...
        qa &&
            u(a, "replaceWith", function (a) {
                ...
                if (k) for (B(b, this), e = 0; e < c.length; e++) (d = c[e]), d instanceof Element && z(b, d);
            });
        ra &&
            u(a, "remove", function () {
                var a = n(this);
    ...
    function za() {
        ...
        function d(a, c) {
            ...
            u(a, "insertAdjacentHTML", function (a, b) {
                ...
                } else if ("afterbegin" === a) (d = this.firstChild), c.call(this, a, b), e(this.firstChild, d);
                else if ("beforeend" === a) (d = this.lastChild), c.call(this, a, b), e(d || this.firstChild, null);
                else if ("afterend" === a) (d = this.nextSibling), c.call(this, a, b), e(this.nextSibling, d);
                else
