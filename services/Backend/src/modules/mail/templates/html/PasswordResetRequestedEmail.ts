import { HtmlEmail } from "@/modules/mail/templates/html/HtmlEmail";
import { IEmailTemplate } from "@/modules/mail/templates/IEmailTemplate";

export class PasswordResetRequestedEmail extends HtmlEmail implements IEmailTemplate {
    public constructor(
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td style="padding:0px;margin:0px;border-spacing:0;">
                                                          ...
                                                          <tbody>
                                                            <tr>
                                                              <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                <div>
                                                                  <div style="font-family: inherit; text-align: center"><span style="font-size: 43px"><strong>Password change requested.</strong></span></div>
                                                                  <div></div>
                                                                </div>
                                                              </td>
                                                            </tr>
                                                          ...
                                                          <tbody>
                                                            <tr>
                                                              <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                <div>
                                                                  <div style="font-family: inherit; text-align: center"><span style="font-size: 14px">You have requested to change your password. Click the buton below to continue.</span></div>
                                                                  <div></div>
                                                                </div>
                                                              </td>
                                                            </tr>
                                                        ...
                                                        <table class="module" role="module" data-type="spacer" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="7770fdab-634a-4f62-a277-1c66b2646d8d.2">
                                                          <tbody>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                              <td align="center" bgcolor="#ffffff" class="outer-td" style="padding:0px 0px 0px 0px; background-color:#ffffff;">
                                                                <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
                                                                  <tbody>
                                                                    <tr>
                                                                      <td align="center" bgcolor="#8000ff" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;"><a href="{{ redirectUrl }}" style="background-color:#8000ff; border:0px solid #8000ff; border-color:#8000ff; border-radius:4px; border-width:0px; color:#ffffff; display:inline-block; font-size:14px; font-weight:700; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit; cursor:pointer;" target="_blank">Change the password</a></td>
                                                                    </tr>
                                                                  </tbody>
                                                                </table>
                                                              </td>
                                                        ...
                                                        <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e.1" data-mc-module-version="2019-10-22">
                                                          <tbody>
                                                            <tr>
                                                              <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                <div>
                                                                  <div style="font-family: inherit; text-align: center"><span style="font-size: 14px">If you have not requested to change your password, you can ignore this email.</span></div>
                                                                  <div></div>
                                                                </div>
                                                              </td>
                                                            </tr>
                                                        ...
                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="d050540f-4672-4f31-80d9-b395dc08abe1.1">
                                                          <tbody>
                                                            <tr>
                                                              <td height="100%" valign="top" role="module-content">
                                                                <div style="font-family: inherit; text-align: center; background-color: #8300ff; padding: 24px;"><a href="{{ appUrl }}" target="_blank" style="color: #ffffff; font-size: 12px"><strong>{{ appName }}, {{ currentYear }}</strong></a></div>
                                                              </td>
                                                            </tr>
                                                          </tbody>
                                                        </table>
