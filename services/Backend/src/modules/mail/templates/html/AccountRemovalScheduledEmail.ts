...
export class AccountRemovalScheduledEmail extends HtmlEmail implements IEmailTemplate {
    public constructor(
    ...
    public getSubject(): string {
        return "Request to close account.";
    }
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td style="padding:0px;margin:0px;border-spacing:0;">
                                                          ...
                                                          <tbody>
                                                            <tr>
                                                              <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                <div>
                                                                  <div style="font-family: inherit; text-align: center"><span style="font-size: 43px"><strong>We will miss you.</strong></span></div>
                                                                  <div></div>
                                                                </div>
                                                              </td>
                                                            </tr>
                                                          ...
                                                          <tbody>
                                                            <tr>
                                                              <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                <div>
                                                                  <div style="font-family: inherit">You have requested to close your account and remove all your data. To cancel this request by reaching out to us before the scheduled removal date - which is {{ toBeRemovedAt }}.</div>
                                                                  <div></div>
                                                                </div>
                                                              </td>
                                                            </tr>
                                                        ...
                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e.1">
                                                          <tbody>
                                                            <tr>
