...
export class UserActivationEmail extends HtmlEmail implements IEmailTemplate {
    public constructor(
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td style="padding:0px;margin:0px;border-spacing:0;">
                                                          ...
                                                          <tbody>
                                                            <tr>
                                                              <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                <div>
                                                                  <div style="font-family: inherit; text-align: center"><span style="font-size: 43px"><strong>Thanks for signing up!</strong></span></div>
                                                                  <div></div>
                                                                </div>
                                                              </td>
                                                            </tr>
                                                          ...
                                                          <tbody>
                                                            <tr>
                                                              <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                <div>
                                                                  <div style="font-family: inherit; text-align: center"><span style="font-size: 14px">Before we can continue, please verify your email address.</span></div>
                                                                  <div style="font-family: inherit; text-align: center"><span style="color: #8000ff; font-size: 14px"><strong>Thank you!</strong></span></div>
                                                                  <div></div>
                                                                </div>
                                                              </td>
                                                            </tr>
                                                        ...
                                                        <table class="module" role="module" data-type="code" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e">
                                                          <tbody>
                                                            <tr>
