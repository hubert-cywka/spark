...
export class UserActivatedEmail extends HtmlEmail implements IEmailTemplate {
    public constructor(
                                                          ...
                                                          <tbody>
                                                            <tr>
                                                              <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                <div>
                                                                  <div style="font-family: inherit; text-align: center"><span style="font-size: 43px"><strong>Account activated!</strong></span></div>
                                                                  <div></div>
                                                                </div>
                                                              </td>
                                                            </tr>
                                                          ...
                                                          <tbody>
                                                            <tr>
                                                              <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                <div>
                                                                  <div style="font-family: inherit; text-align: center"><span style="font-size: 14px">Your email has been verified and we activated your account.</span></div>
                                                                  <div></div>
                                                                </div>
                                                              </td>
                                                            </tr>
