...
export class PasswordResetRequestedEmail implements IEmailTemplate {
    ...
    public getBody(): string {
        ...
        return `<h1>Hi!</h1><p>Please click the link below to set new password:</p><p><a href="${resetPasswordLink}">${resetPasswordLink}</a></p><p>If you did not request to change the password, you can simply ignore this mail.</p>`;
    }
}
