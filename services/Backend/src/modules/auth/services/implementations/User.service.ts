...
import { InvalidCredentialsError } from "@/modules/auth/errors/InvalidCredentials.error";
import { UserAlreadyActivatedError } from "@/modules/auth/errors/UserAlreadyActivated.error";
import { UserAlreadyExistsError } from "@/modules/auth/errors/UserAlreadyExists.error";
import { UserNotFoundError } from "@/modules/auth/errors/UserNotFound.error";
import { User } from "@/modules/auth/models/User.model";
import { IUserService } from "@/modules/auth/services/interfaces/IUser.service";
import { IUserPublisherService, IUserPublisherServiceToken } from "@/modules/auth/services/interfaces/IUserPublisher.service";
...
export class UserService implements IUserService {
    ...
    public async requestPasswordChange(email: string): Promise<void> {
        ...
        this.publisher.onPasswordResetRequested(user.email, passwordResetToken);
    }
