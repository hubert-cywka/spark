...
export class AddFeatureFlagsTable1765020949930 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "feature_flag" ADD CONSTRAINT "FK_6d71049e9b27b7c73c266168c64" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
