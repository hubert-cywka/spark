...
export class InitDatabase1731437155592 implements MigrationInterface {
    name = "InitDatabase1731437155592";
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            'CREATE TABLE "account" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "providerAccountId" character varying NOT NULL, "email" character varying NOT NULL, "activatedAt" TIMESTAMP, "termsAndConditionsAcceptedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "providerId" character varying, "password" character varying, "type" character varying NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))'
        );
