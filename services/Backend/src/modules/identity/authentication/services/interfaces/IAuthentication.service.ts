...
export interface IAuthenticationService {
    ...
    loginWithExternalIdentity(identity: ExternalIdentity, withSudoMode?: boolean): Promise<AuthenticationResult>;

    // TODO: Remove DTO
    registerWithCredentials(registerDto: RegisterWithCredentialsDto): Promise<void>;
    loginWithCredentials(email: string, password: string, withSudoMode?: boolean): Promise<AuthenticationResult>;
