...
import { type ITwoFactorAuthenticationIntegrationsProvider } from "@/modules/identity/2fa/services/interfaces/ITwoFactorAuthenticationIntegrationsProvider";
import { TwoFactorAuthenticationMethod } from "@/modules/identity/2fa/types/TwoFactorAuthenticationMethod";
import { IDENTITY_MODULE_DATA_SOURCE } from "@/modules/identity/infrastructure/database/constants";

export class TwoFactorAuthenticationIntegrationsProvider implements ITwoFactorAuthenticationIntegrationsProvider {
    private readonly logger = new Logger(TwoFactorAuthenticationIntegrationsProvider.name);
